...
class extent_server {
 private:
  ...
  typdef std::map<extent_protocol::extentid_t, pContent> ExtentMap;
  ...
  typedef std::set<pDirEntry> DirEntries;
  typedef std::map<extent_protocol::extentid_t, pDirEntries> DirMap;
